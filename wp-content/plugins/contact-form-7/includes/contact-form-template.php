...
<div class="row">
    <div class="col-md-6">
      [text* your-name id:form-name placeholder "Name"]
    </div>
    <div class="col-md-6">
        [text* your-email id:form-email placeholder "Email"]
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
<div class="row">
    <div class="col-md-12">
        [textarea* your-message id:form-message placeholder "Type here"]
        [submit id:contact-submit class:submit-btn class:btn-style3 class:clearfix]
    </div>
</div>',
